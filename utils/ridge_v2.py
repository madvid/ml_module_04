...
#                                Functions                                    #
# ########################################################################### #
def check_types(arg1, arg2):
    """
    """
    if (not isinstance(arg1, np.ndarray)) \
            or (not isinstance(arg2, np.ndarray)):
        s = "Numpy arrays are expected."
        print(s, file=sys.stderr)
        sys.exit()


def check_measurement(s_arg1, s_arg2, myridge, arr_1, arr_2):
    """
    """
...
class MyRidge(MyLinearRegression):
    ...
    def loss_(self, y, y_hat):
        ...
        """
        check_types(y, y_hat)
        check_measurement('y', 'y', self, y, y_hat)
        try:
    ...
    def gradient_(self, x, y):
        ...
        """
        check_types(x, y)
        check_measurement('x', 'y', self, x, y)
        try:
